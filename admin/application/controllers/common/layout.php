<?php defined('BASEPATH') OR exit('No direct script access allowed');
	class Layout extends MX_Controller {
		...
		protected function getList() {
			...
			$this->pagination->url = $this->url->link('design/layout', 'user_token=' . $this->session->userdata('user_token') . $url . '&page={page}', true);
		...
		protected function getForm() {
			...
			$data['text_route'] = $this->lang->line('text_route');
			...
			$data['text_menu_header'] = $this->lang->line('text_menu_header');
			...
			$data['text_remove'] = $this->lang->line('text_remove');
			
			$data['entry_name'] = $this->lang->line('entry_name');
			$data['entry_store'] = $this->lang->line('entry_store');
			$data['entry_route'] = $this->lang->line('entry_route');
			...
			foreach ($layout_modules as $layout_module) {
				...
				$this->lang->load('module/' . $part[0]);
				
				if (!isset($part[1])) {
					$data['layout_modules'][] = array(
						'name'       => strip_tags($this->lang->line('heading_title')),
						'code'       => $layout_module['code'],
						'edit'       => $this->url->link('module/' . $part[0], 'user_token=' . $this->session->userdata('user_token'), true),
					...
					if ($module_info) {
						$data['layout_modules'][] = array(
							...
							'code'       => $layout_module['code'],
							'edit'       => $this->url->link('module/' . $part[0], 'user_token=' . $this->session->userdata('user_token') . '&module_id=' . $part[1], true),
							'position'   => $layout_module['position'],
							'sort_order' => $layout_module['sort_order']
						);
					}				
