<?php
	class CategoryBlog extends MX_Controller {
		...
		public function add() {
			...
			$this->load->model('blogs/categoryblog_model','model_catalog_categoryblog');

			if (($this->input->userdata('REQUEST_METHOD') == 'POST') && $this->validateForm()) {
				$this->model_catalog_categoryblog->addCategoryblog($this->input->post());
		...
		public function edit() {
			...
			if (($this->input->server('REQUEST_METHOD') == 'POST') && $this->validateForm()) {
				$this->model_catalog_categoryblog->editCategoryblog($this->input->get('categoryblog_id'), $this->input->post());
		...
		public function delete() {
			...
			if (($this->input->post['selected']) && $this->validateDelete()) {
				...
				foreach ($this->input->post['selected'] as $categoryblog_id) {
					$this->model_catalog_categoryblog->deleteCategoryblog($categoryblog_id);
				}
		...
		public function repair() {
			...
			if ($this->validateRepair()) {
				$this->model_catalog_categoryblog->repairCategories();
		...
		protected function getList() {
			...
			$categoryblog_total = $this->model_catalog_categoryblog->getTotalCategories();
			$results = $this->model_catalog_categoryblog->getCategories($filter_data);
		...
		protected function getForm() {
			...
			if (($this->input->get('categoryblog_id')) && ($this->input->server('REQUEST_METHOD') != 'POST')) {
				$categoryblog_info = $this->model_catalog_categoryblog->getCategoryblog($this->input->get('categoryblog_id'));
			}
			...
			if ($this->input->post('categoryblog_description')) {
				...
				$data['categoryblog_description'] = $this->model_catalog_categoryblog->getCategoryblogDescriptions($this->input->get('categoryblog_id'));
			} else {
			...
			if ($this->input->post('categoryblog_filter')) {
				...
				$filters = $this->model_catalog_categoryblog->getCategoryblogFilters($this->input->get('categoryblog_id'));
			} else {
				$filters = array();
			}
			...
			if ($this->input->post('categoryblog_store')) {
				...
				$data['categoryblog_store'] = $this->model_catalog_categoryblog->getCategoryblogStores($this->input->get('categoryblog_id'));
			} else {
			...
			if ($this->input->post('categoryblog_seo_url')) {
				...
				$data['categoryblog_seo_url'] = $this->model_catalog_categoryblog->getCategoryblogSeoUrls($this->input->get('categoryblog_id'));
			} else {
			...
			if ($this->input->post('categoryblog_layout')) {
				...
				$data['categoryblog_layout'] = $this->model_catalog_categoryblog->getCategoryblogLayouts($this->input->get('categoryblog_id'));
			} else {
		...
		protected function validateForm() {
			...
			if (($this->input->get('categoryblog_id')) && $this->input->post('parent_id')) {
				$results = $this->model_catalog_categoryblog->getCategoryblogPath($this->input->post['parent_id']);
