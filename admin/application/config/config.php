...
|
*/
$config['enable_hooks'] = TRUE; // SSL ACTIVE
...
// Path defined in Codeigniter.
define('PATH_BASE', dirname(BASEPATH) . '/');
define('PATH_APPLICATION', PATH_BASE . '/admin/application/');
...
define('DIR_LANGUAGE', DIR_HOME.'admin/application/language/');
define('DIR_TEMPLATE', DIR_HOME.'admin/application/views/');
define('DIR_CONFIG', DIR_HOME.'admin/application/config/');
define('DIR_IMAGE', DIR_HOME.'image/');
define('DIR_CACHE', DIR_HOME.'admin/application/cache/');
