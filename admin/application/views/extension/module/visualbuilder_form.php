            	...
            	<div class="row builder-actions">
	            	...
	            	<div class="col-md-2">
		              ...
		              <?php if ($layout['layout_id'] == $selected_layout) { ?>
		                    ...
		                    <option data-route="<?php echo $layout['route']; ?>" name="layout_id" value="<?php echo $layout['edit']; ?>" selected="selected" />
		                    <?php } else { ?>
		                    <option data-route="<?php echo $layout['route']; ?>" name="layout_id" value="<?php echo $layout['edit']; ?>" />
		                    <?php } ?>
    	      ...
    	      <div class="col-md-9">
    	      	<div class="">
	    	      	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-layout" class="form-horizontal">
	                	<?php if (file_exists($adminLayoutDir.strtolower($name). '.tpl' )) { include ($adminLayoutDir.strtolower($name). '.tpl' ); } else { if($show_position){ include ($adminLayoutDir . "main_custom.php");}else{ include ($adminLayoutDir . "main.php"); } } ?>
	            		<input type="hidden" id="confirmleave" name="confirmleave" value="0">
	            	</form>
            	</div>
            </div>
            <div class="col-md-3">
                <?php include ($adminBuilderViewDir . "modules.php"); ?>
            </div>
       </div>
