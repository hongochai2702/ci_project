   ...
   <div class="container-fluid">
      ...
      <div class="tab-content">
         <div class="tab-pane active" id="tab-general">
            <?php $image_command=(!empty($image_manager_command))?$image_manager_command:array();
               $commands = array(
                   'mkdir'     =>$text_mkdir,
                   'mkfile'    =>$text_mkfile,
                   'upload'    =>$text_upload,
         ...
         <div class="tab-pane" id="tab-setting">
            <div class="panel panel-default">
               <div class="panel-heading">
                  ...
                  <a onclick="$('#form').submit();" class="btn btn-primary btn-xs pull-right"><span><i class="fa fa-save"></i> <?php echo $button_save; ?></span></a>
               </div>
               <div class="panel-body">
                  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="form">
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                           <select name="image_manager_status" class="form-control">
                              <option value="1" <?php echo ($image_manager_status=='1')?'selected="selected"':'';?>><?php echo $text_enabled;?></option>
                              <option value="0" <?php echo ($image_manager_status=='0')?'selected="selected"':'';?>><?php echo $text_disabled;?></option>
                           </select>
                        </div>
                     </div>
                     <!-- form-group--> 
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                 ...
                                 <div class="well well-sm" style="min-height:300px;overflow: auto;">
                                    ...
                                    <div class="checkbox">
                                       <label>
                                       <input type="checkbox" name="image_manager_command[<?php echo $user_group['user_group_id']; ?>][<?php echo $command; ?>]" value="1" 
                                          <?php echo (!empty($image_manager_command[$user_group['user_group_id']][$command]))?'checked="checked"':''; ?>/>
