              ...
              <div class="table-responsive">
                <table class="table table-bordered table-hover">
                  <thead>
                    ...
                    <?php } else { ?><a href="<?php echo $sort_model; ?>"><?php echo $column_model; ?></a>
                    <?php } ?></td>
                ...
                <?php foreach ($products as $product) { ?>
                  ...
                  <td class="text-right"><?php if ($product['special']) { ?> <span style="text-decoration: line-through;"><?php echo $product['price']; ?></span><br/>
...
$('#button-filter').on('click', function() {
	...
	location = 'catalog/product?user_token=<?php echo $user_token; ?>' + url;
});
//--></script> 
  <script type="text/javascript"><!--
// IE and Edge fix!
