              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($blog['blog_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-center"><?php if ($blog['image']) { ?>
                    <img src="<?php echo $blog['image']; ?>" alt="<?php echo $blog['name']; ?>" class="img-thumbnail" />
                    <?php } else { ?>
                    <span class="img-thumbnail list"><i class="fa fa-camera fa-2x"></i></span>
                    <?php } ?></td>
                  <td class="text-left"><?php echo $blog['name']; ?></td>
                  <td class="text-left"><?php echo $blog['model']; ?></td>
...
$('#button-filter').on('click', function() {
  var url = 'index.php?routes=catalog/blog&token=<?php echo $token; ?>';
...
$('input[name=\'filter_name\']').autocomplete({
  'source': function(request, response) {
    $.ajax({
      url: 'index.php?routes=catalog/blog/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
      dataType: 'json',
...
$('input[name=\'filter_model\']').autocomplete({
  'source': function(request, response) {
    $.ajax({
      url: 'index.php?routes=catalog/blog/autocomplete&token=<?php echo $token; ?>&filter_model=' +  encodeURIComponent(request),
      dataType: 'json',
      success: function(json) {
        response($.map(json, function(item) {
          return {
