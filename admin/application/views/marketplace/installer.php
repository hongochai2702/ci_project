...
$('#history').load('<?php echo URL_HOME; ?>admin/marketplace/installer/history?user_token=<?php echo $user_token; ?>');
...
$('#button-upload').on('click', function() {
	...
	timer = setInterval(function() {
		if ($('#form-upload input[name=\'file\']').val() != '') {
			...
			$.ajax({
				url: '<?php echo URL_HOME; ?>admin/marketplace/installer/upload?user_token=<?php echo $user_token; ?>',
				type: 'post',
				dataType: 'json',
...
$('#history').on('click', '.btn-danger', function(e) {
	...
	$.ajax({
		url: '<?php echo URL_HOME; ?>admin/marketplace/install/uninstall?user_token=<?php echo $user_token; ?>&extension_install_id=' + $(this).attr('value'),
		dataType: 'json',
		beforeSend: function() {
