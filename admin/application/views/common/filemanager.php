...
$('#button-search').on('click', function(e) {
	var url = 'common/filemanager?user_token=<?php echo $user_token; ?>&directory=<?php echo $directory; ?>';
...
$('#button-upload').on('click', function() {
	...
	timer = setInterval(function() {
		if ($('#form-upload input[name=\'file\']').val() != '') {
			...
			$.ajax({
				url: 'common/filemanager/upload?user_token=<?php echo $user_token; ?>&directory=<?php echo $directory; ?>',
				type: 'post',		
				dataType: 'json',
...
$('#button-folder').on('shown.bs.popover', function() {
	$('#button-create').on('click', function() {
		$.ajax({
			url: 'common/filemanager/folder?user_token=<?php echo $user_token; ?>&directory=<?php echo $directory; ?>',
			type: 'post',		
			dataType: 'json',
...
$('#modal-image #button-delete').on('click', function(e) {
	if (confirm('<?php echo $text_confirm; ?>')) {
		$.ajax({
			url: 'common/filemanager/delete?user_token=<?php echo $user_token; ?>',
			type: 'post',		
			dataType: 'json',
