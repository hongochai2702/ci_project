...
define('DIR_APPLICATION', DIR_HOME );
define('DIR_SYSTEM', SYSDIR . '/');
define('DIR_LANGUAGE', DIR_APPLICATION.'language/');
define('DIR_TEMPLATE', DIR_HOME.'views/');
define('DIR_CONFIG', DIR_HOME.'system/config/');
define('DIR_IMAGE', PATH_BASE.'image/');
define('DIR_CACHE', DIR_HOME.'cache/');
define('DIR_DOWNLOAD', DIR_HOME.'/download/');
define('DIR_UPLOAD', DIR_HOME.'/upload/');
define('DIR_LOGS', DIR_HOME.'/logs/');
define('DIR_MODIFICATION', DIR_HOME.'system/modification/');
define('DIR_CATALOG', DIR_HOME.'application/catalog/');
