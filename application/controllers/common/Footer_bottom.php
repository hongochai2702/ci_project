<?php
class Footer_bottom extends MX_Controller {
	public function index() {
		...
		$modules = $this->layout_model->getLayoutModules($layout_id, 'footer_bottom');
		if($modules) {
		...
		return $this->load->view('default/common/footer_bottom', $data, true);
	}
}
