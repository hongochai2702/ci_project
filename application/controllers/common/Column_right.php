<?php
class Column_right extends MX_Controller {
	public function index() {
		...
		$modules = $this->layout_model->getLayoutModules($layout_id, 'column_right');
		...
		return $this->load->view('default/common/column_right', $data);
	}
}
