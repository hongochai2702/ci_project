<?php
class Footer_top extends MX_Controller {
	public function index() {
		...
		$modules = $this->layout_model->getLayoutModules($layout_id, 'footer_top');
		...
		return $this->load->view('default/common/footer_top', $data, true);
	}
}
